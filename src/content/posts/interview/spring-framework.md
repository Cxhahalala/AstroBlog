...
![](https://cdn.jsdelivr.net/gh/Cxhahalala/hexo-images-1@main/images/6522fed14e2e8005.png)
1. 如果方法抛出检查型异常（checked exception），并且没有在`@Transactional`注解上配置`rollbackFor`属性为`Exception`，那么异常发生时事务可能不会回滚。
![](https://cdn.jsdelivr.net/gh/Cxhahalala/hexo-images-1@main/images/e5f39b0e41086a35.png)
1. 如果事务注解的方法不是公开（public）修饰的，也可能导致事务失效。
![](https://cdn.jsdelivr.net/gh/Cxhahalala/hexo-images-1@main/images/260caf5551b7eedb.png)
**理解：**
...
一级缓存和二级缓存一起工作
![](https://cdn.jsdelivr.net/gh/Cxhahalala/hexo-images-1@main/images/da4bba34b1d93f96.png)
...
![](https://cdn.jsdelivr.net/gh/Cxhahalala/hexo-images-1@main/images/efc4007f9a055d5e.png)
三级缓存解决循环依赖问题
![](https://cdn.jsdelivr.net/gh/Cxhahalala/hexo-images-1@main/images/9dfa53624251f37f.png)
需要自己解决的循环依赖
![](https://cdn.jsdelivr.net/gh/Cxhahalala/hexo-images-1@main/images/9a2c829012b0f7d0.png)
**理解：**
...
#
![](https://cdn.jsdelivr.net/gh/Cxhahalala/hexo-images-1@main/images/22971d112cf88394.png)
...
![](https://cdn.jsdelivr.net/gh/Cxhahalala/hexo-images-1@main/images/76a4e5cc703217b8.png)
...
# SpringMvc常见注解
![](https://cdn.jsdelivr.net/gh/Cxhahalala/hexo-images-1@main/images/6aceb218d894e255.png)
SpringMVC的常见注解有：
...
# SpringBoot常见注解
![](https://cdn.jsdelivr.net/gh/Cxhahalala/hexo-images-1@main/images/d88d4ae0e02c512a.png)
Spring Boot的常见注解包括：
...
-
# MyBatis执行流程
![](https://cdn.jsdelivr.net/gh/Cxhahalala/hexo-images-1@main/images/7286bbce618b36c9.png)
MyBatis的执行流程如下：
...
7. 输出结果映射。
# MyBatis是否支持延迟加载
![](https://cdn.jsdelivr.net/gh/Cxhahalala/hexo-images-1@main/images/8d53230e02f6b30b.png)
### 简单理解
...
# 延迟加载的底层原理
![](https://cdn.jsdelivr.net/gh/Cxhahalala/hexo-images-1@main/images/d229756dc8fc9f25.png)
...
---
# MyBatis一级缓存和二级缓存
![](https://cdn.jsdelivr.net/gh/Cxhahalala/hexo-images-1@main/images/65422c0656145b96.png)
## 一级缓存
![](https://cdn.jsdelivr.net/gh/Cxhahalala/hexo-images-1@main/images/cc9a149c81c9cf9b.png)
