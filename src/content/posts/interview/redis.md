...
# Redis缓存问题
![](https://cdn.jsdelivr.net/gh/Cxhahalala/hexo-images-1@main/images/84e343378853fa96.png)
## 缓存穿透
### 原理
...
![](https://cdn.jsdelivr.net/gh/Cxhahalala/hexo-images-1@main/images/119e5a6bf68b8548.png)
### 回答
![](https://cdn.jsdelivr.net/gh/Cxhahalala/hexo-images-1@main/images/8900b77cd5e3449e.png)
## 缓存击穿
### 原理
...
## 缓存雪崩
### 原理
![](https://cdn.jsdelivr.net/gh/Cxhahalala/hexo-images-1@main/images/775af8ce683a3a93.png)
### 回答
![](https://cdn.jsdelivr.net/gh/Cxhahalala/hexo-images-1@main/images/d984ced2b7d2db26.png)
## 总结
![](https://cdn.jsdelivr.net/gh/Cxhahalala/hexo-images-1@main/images/6f5f445cf4810674.png)
# 双写一致性
![](https://cdn.jsdelivr.net/gh/Cxhahalala/hexo-images-1@main/images/df17c35431d37b33.png)
## 强一致性
![](https://cdn.jsdelivr.net/gh/Cxhahalala/hexo-images-1@main/images/091b32a78c6ff0e5.png)
## 先删除缓存再操作数据库
正常情况
![](https://cdn.jsdelivr.net/gh/Cxhahalala/hexo-images-1@main/images/a54993e1bd50e005.png)
非正常情况，可能会出现数据不一致问题
![](https://cdn.jsdelivr.net/gh/Cxhahalala/hexo-images-1@main/images/f24fa3af706d93c4.png)
## 先操作数据库再删除缓存
正常情况
![](https://cdn.jsdelivr.net/gh/Cxhahalala/hexo-images-1@main/images/2aca7457103e0e93.png)
非正常情况
![](https://cdn.jsdelivr.net/gh/Cxhahalala/hexo-images-1@main/images/43799cc4a6b3b163.png)
当线程一恰好查到过期的缓存，查数据库，此时线程二还未操作数据库，线程一拿到的是旧数据，也会把旧数据写入缓存，造成缓存和数据库数据不一致
## 因此两种操作都会导致数据不一致
## 延时双删
![](https://cdn.jsdelivr.net/gh/Cxhahalala/hexo-images-1@main/images/b4dbc38808ead9c3.png)
## 读写锁对比分布式锁
![](https://cdn.jsdelivr.net/gh/Cxhahalala/hexo-images-1@main/images/10cc96e108c332c3.png)
...
## 对一致性要求不严格的场景
![](https://cdn.jsdelivr.net/gh/Cxhahalala/hexo-images-1@main/images/c85105cabb40c6c7.png)
由于使用的消息中间件，所以必定有延迟
![](https://cdn.jsdelivr.net/gh/Cxhahalala/hexo-images-1@main/images/a5f971dd8a6cc06b.png)
## 回答
![](https://cdn.jsdelivr.net/gh/Cxhahalala/hexo-images-1@main/images/6566c3683e348265.png)
# Redis持久化问题
...
## 惰性删除
![](https://cdn.jsdelivr.net/gh/Cxhahalala/hexo-images-1@main/images/3ea142715d998280.png)
即使用的时候判断一次
## 定期删除
![](https://cdn.jsdelivr.net/gh/Cxhahalala/hexo-images-1@main/images/f0d85dbf4fdb2f85.png)
## 回答
![](https://cdn.jsdelivr.net/gh/Cxhahalala/hexo-images-1@main/images/88a3227d17e5862c.png)
# Redis淘汰策略
## 原理
...
# 分布式锁
![](https://cdn.jsdelivr.net/gh/Cxhahalala/hexo-images-1@main/images/b876ee732edb1c28.png)
## 抢券场景超卖问题
![](https://cdn.jsdelivr.net/gh/Cxhahalala/hexo-images-1@main/images/36524b4ea3138a82.png)
**正常情况**
![](https://cdn.jsdelivr.net/gh/Cxhahalala/hexo-images-1@main/images/21b6a2cfb3348376.png)
**出现超卖**
![](https://cdn.jsdelivr.net/gh/Cxhahalala/hexo-images-1@main/images/8342db48816ef637.png)
**线程一和线程二查询的时候都是1，两个都减去一个，那么库存变成-1，即出现了超卖问题**
## 互斥锁
**使用互斥锁**
![](https://cdn.jsdelivr.net/gh/Cxhahalala/hexo-images-1@main/images/1de37d8bbe6db41e.png)
**但互斥锁只能在同一个jvm中生效，如果多台机器同时部署，那么无法获得同一把锁**
## 分布式锁
![](https://cdn.jsdelivr.net/gh/Cxhahalala/hexo-images-1@main/images/bd814c12523fd145.png)
**获得的不是同一把锁**
![](https://cdn.jsdelivr.net/gh/Cxhahalala/hexo-images-1@main/images/eaf87fbfd18c5786.png)
**使用Redis作为分布式锁**
![](https://cdn.jsdelivr.net/gh/Cxhahalala/hexo-images-1@main/images/7d4bf92ec7120d16.png)
# 分布式锁原理
![](https://cdn.jsdelivr.net/gh/Cxhahalala/hexo-images-1@main/images/eb65aae2af3bb5b7.png)
...
---
## 分布式锁Redisson
![](https://cdn.jsdelivr.net/gh/Cxhahalala/hexo-images-1@main/images/4f7019d9eacd9132.png)
redisson的重试机制并不是一直循环等待
![](https://cdn.jsdelivr.net/gh/Cxhahalala/hexo-images-1@main/images/dff7a3afbefc36ec.png)
...
## Redisson可重入锁
**同一个线程可以重复获取同一把锁**
![](https://cdn.jsdelivr.net/gh/Cxhahalala/hexo-images-1@main/images/66b11d362b659a52.png)
每次获取一次锁value+1,释放一次锁value-1
## Redisson主从一致性
![](https://cdn.jsdelivr.net/gh/Cxhahalala/hexo-images-1@main/images/e93209b9419aee28.png)
**当写入从主节点获取锁时，主节点宕机那么redis的哨兵机制会重新推举出一个主节点，此时一个新的线程来获取锁可以成功，那么锁的互斥性就失效了，可能会出现脏数据问题**
---
![](https://cdn.jsdelivr.net/gh/Cxhahalala/hexo-images-1@main/images/41aaf221b5728997.png)
**使用zookeeper可以实现分布式锁的强一致性**
---
## 总结
![](https://cdn.jsdelivr.net/gh/Cxhahalala/hexo-images-1@main/images/12fffe49de7f8aeb.png)
# Redis集群方案
![](https://cdn.jsdelivr.net/gh/Cxhahalala/hexo-images-1@main/images/7acf3fa287b14d5a.png)
## 主从复制
### 原理
...
![](https://cdn.jsdelivr.net/gh/Cxhahalala/hexo-images-1@main/images/23a47fcacfdfff8e.png)
**假如网络出现问题，哨兵无法监测主节点，主节点也没有宕机，那么此时哨兵会从从节点中推举出一个主节点，此时有两个主节点，即脑裂**
![](https://cdn.jsdelivr.net/gh/Cxhahalala/hexo-images-1@main/images/aa892e5c05061e82.png)
**网络恢复后，老的master节点会被降级成为slave几点，此时从新的master节点同步数据，老的master会清空自己的数据，但之前脑裂客户端也向老master节点写入数据，导致数据丢失**
![](https://cdn.jsdelivr.net/gh/Cxhahalala/hexo-images-1@main/images/f6e92c60c9531725.png)
**通过这两个配置，达不到这样的要求，则拒绝客户端的写入请求，防止大量数据丢失**
### 回答
![](https://cdn.jsdelivr.net/gh/Cxhahalala/hexo-images-1@main/images/f0abe6396fc2858b.png)
## 分片集群
### 原理
...
### 回答
![](https://cdn.jsdelivr.net/gh/Cxhahalala/hexo-images-1@main/images/04efa826f36f710b.png)
**分片集群解决了海量数据存储，高并发写的问题，同时也有哨兵模式的自动推举master**
# Redis单线程为什么还快
![](https://cdn.jsdelivr.net/gh/Cxhahalala/hexo-images-1@main/images/e1786dd434e67c0a.png)
## 用户空间与内核空间
![](https://cdn.jsdelivr.net/gh/Cxhahalala/hexo-images-1@main/images/67b6716c5a3d588e.png)
## 阻塞IO
![](https://cdn.jsdelivr.net/gh/Cxhahalala/hexo-images-1@main/images/9e234cf0d1802221.png)
## 非阻塞IO
![](https://cdn.jsdelivr.net/gh/Cxhahalala/hexo-images-1@main/images/a8b39b3b13097be8.png)
这种效率也不高
## IO多路复用
...
加入了两个多线程，降低了网络IO
## 总结
![](https://cdn.jsdelivr.net/gh/Cxhahalala/hexo-images-1@main/images/cb3945b5c1dc55cb.png)